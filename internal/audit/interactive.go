...
func RunInteractiveIssueCreation(
	...
	for _, g := range groups {
		candidates = append(candidates, github.IssueCandidate{
			...
			Body:    buildGroupBody(g, result.Model),
		})
	}
...
func buildGroupBody(g FindingGroup, model string) string {
	return renderGroupMarkdown(g, true, model)
}

// renderGroupMarkdown renders a finding group as Markdown. When withFooter is
// true, a footer naming the resolved Claude model is appended for the GitHub
// issue body.
func renderGroupMarkdown(g FindingGroup, withFooter bool, model string) string {
	var b bytes.Buffer

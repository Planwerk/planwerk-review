...
// planCommentMarker is the stable, model-independent prefix of the plan
// comment footer. mostRecentPlanComment keys its lookup on it (rather than the
// full footer) so a plan posted under one model is still recognized after the
// default model changes — planCommentFooter appends the model-aware suffix.
const planCommentMarker = "_Implementation plan generated by " + attribution.Link + " implement " + attribution.AssistantMarker
...
func planCommentFooter() string {
	return "_Implementation plan generated by " + attribution.Link + " implement " + attribution.Assistant() + "_"
}
...
func reportCommentFooter() string {
	return "_Implementation report generated by " + attribution.Link + " implement " + attribution.Assistant() + "_"
}

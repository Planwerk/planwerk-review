...
// planCommentFooter attributes the posted plan to planwerk-review, matching
// the footer the propose/elaborate/audit subcommands append to the artifacts
// they leave on GitHub.
const planCommentFooter = "_Implementation plan generated by [planwerk-review](https://github.com/planwerk/planwerk-review) implement with Claude Code_"
...
// planwerk-review, matching the footer the plan/fix subcommands append to the
// artifacts they leave on GitHub.
const reportCommentFooter = "_Implementation report generated by [planwerk-review](https://github.com/planwerk/planwerk-review) implement with Claude Code_"

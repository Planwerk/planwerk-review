...
7. Output an address report in this exact shape:
...
- If there is nothing to commit (every thread was BLOCKED/NEEDS_CONTEXT), do NOT create an empty commit and do NOT push; output the report and stop.
`)

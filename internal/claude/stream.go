...
// model, effort, and permission-mode handling: permissionMode, when
// non-empty, is passed to claude as --permission-mode.
func runClaudeStream(dir, prompt, label, permissionMode string) (string, error) {

...
// passed to claude as --permission-mode; model is the --model value the
// caller selected (claudeModel or planModel).
func runClaudeStream(dir, prompt, label, permissionMode, model string) (string, error) {

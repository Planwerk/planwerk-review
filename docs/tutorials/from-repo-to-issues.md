...
planwerk-agent is installed and `gh` is authenticated before you begin.
...
planwerk-agent clones the repo, runs a deep Claude analysis covering
...
`--create-issues`. planwerk-agent shows a summary table and walks you through
